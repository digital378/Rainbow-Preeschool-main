...
- **Author Page**: `/about/dr-meghna-rai` — E-E-A-T author page for Dr. Meghna Rai (Head of Curriculum) with Person JSON-LD, expertise areas, and links to blog posts. SSR entry in `server/ssr-pages.ts`, route in `App.tsx`, sitemap entry added.

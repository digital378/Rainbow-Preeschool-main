...
// A single edit here updates the visible byline, the Article schema
// dateModified AND the sitemap <lastmod> across:
...
//   • Every `<lastmod>` in the dynamic /sitemap.xml route
//     (`server/index.ts` → `buildSitemapXml()` in `shared/sitemap-entries.ts`)
//
// LAST_UPDATED_ISO     → ISO-8601 date used in JSON-LD + sitemap (e.g. "2026-04-24")

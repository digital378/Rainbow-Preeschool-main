...
const fullFormSchema = z.object({
  ...
  childAge: z.string().min(1, "Please select child's age"),
  programme: z.string().default("Happy Times"),
  branch: z.string().min(1, "Please select a centre"),
  ...
  const mutation = useMutation({
    mutationFn: async (data: CallbackFormData) => {
      const response = await apiRequest("POST", "/api/contact", {
        ...
        email: "",
        message: "Quick callback request from Happy Times page",
      });
    ...
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background border-t shadow-lg p-3 flex gap-2">
        <Button 
          ...
          data-testid="button-happytimes-sticky-callback"
        >
        ...
        <Button 
          variant="outline" 
          className="flex-1"
          onClick={() => window.open("https://wa.me/918291568972?text=Hi, I'm interested in Happy Times after-school care", "_blank")}
          data-testid="button-happytimes-sticky-whatsapp"
        >
          ...
          <Card className="w-full max-w-md max-h-[90vh] overflow-y-auto">
            <CardContent className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button variant="ghost" size="icon" aria-label="Close form" onClick={() => setShowForm(false)} data-testid="button-happytimes-modal-close">
                  <span className="text-xl" aria-hidden="true">&times;</span>
                </Button>
              </div>
              <ContactForm defaultProgramme="Happy Times" onSuccess={() => setShowForm(false)} />
            </CardContent>
          </Card>
        </div>
      )}
...
export default function HappyTimesLanding() {
  useEffect(() => {
    trackProgrammeView("happy-times");
  }, []);
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button 
                  ...
                  size="lg"
                  onClick={() => window.open("https://wa.me/918291568972?text=Hi, I'm interested in Happy Times after-school care", "_blank")}
                  data-testid="button-happytimes-hero-whatsapp"
                >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="text-center mt-8">
              ...
              <Button 
                ...
                data-testid="button-happytimes-faq-callback"
              >
                Request a Callback
              </Button>
            </div>
      ...
      <section className="py-10 md:py-12 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <Link href="/best-preschool-in-thane" className="flex flex-col items-center gap-1.5 p-3 md:p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary hover:shadow-md transition-all text-center" data-testid="link-happytimes-best-preschool">
          ...
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                variant="secondary"
                onClick={() => document.getElementById('enquiry-form')?.scrollIntoView({ behavior: 'smooth' })}
                data-testid="button-happytimes-final-callback"
              >
              ...
              <Button 
                ...
                onClick={() => window.open("https://wa.me/918291568972?text=Hi, I'm interested in Happy Times after-school care", "_blank")}
                data-testid="button-happytimes-final-whatsapp"
              >
                <SiWhatsapp className="mr-2 h-5 w-5" /> WhatsApp Us
              </Button>
              <Link href="/contact">
                <Button 
                  ...
                  variant="outline"
                  className="border-white text-white hover:bg-white/20"
                  data-testid="button-happytimes-final-centres"
                >

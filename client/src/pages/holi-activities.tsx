...
import { ChevronRight, Phone, MessageCircle, BookOpen, GraduationCap, MapPin, Download, ChevronDown, ChevronUp, Palette, Music, Shield, Users, Flame, PenTool, Award, Share2, Heart, Sparkles } from "lucide-react";
              ...
              <div className="lg:col-span-2">
                ...
                <section id="history" className="mb-12 scroll-mt-24">
                  ...
                  <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground leading-relaxed space-y-4">
                    ...
                    <p>Angered by his son's devotion, the king tried to punish him. He sought help from his sister <strong>Holika</strong>, who had a magical shawl that protected her from fire. She sat in a fire holding Prahlad, intending to burn him. However:</p>
                ...
                <div className="my-8 p-6 bg-primary/5 rounded-md border border-primary/20">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      { text: "Our Centres in Thane", url: "/centres" },
                      { text: "Admissions Information", url: "/admissions" },

...
const CONFIG = {
  ...
  faq: {
    ...
    items: [
      {
        question: "How does Rainbow Preschools compare to other schools in Thane like Mindseed, Kangaroo Kids, The Learning Curve, Orchids International School, Podar International School, or Smt. Sulochanadevi Singhania School?",
        answer: "Rainbow Preschools focuses on strong early childhood development through activity-based learning, helping children build confidence, communication skills, and a solid foundation in their early years.\n\nWhile preschools like Mindseed, Kangaroo Kids, and The Learning Curve offer structured early learning programmes, and larger institutions such as Orchids International School, Podar International School, and Smt. Sulochanadevi Singhania School provide broader K–12 education, Rainbow offers the advantage of both.\n\nWith a dedicated preschool environment and the option to transition into our K–12 branch at Brahmand, parents benefit from continuity in their child's learning journey along with personalized attention during the early years.",
      },
      {

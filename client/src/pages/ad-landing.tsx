...
export default function AdLanding() {
  ...
  const campusImages = [
    ...
    { src: '/images/campus/campus-corridor.webp', label: 'Welcome Lobby', color: '#3b82f6' },
    { src: '/images/campus/campus-hallway.webp', label: 'Vibrant Hallways', color: '#8b5cf6' },
    { src: '/images/campus/campus-nature-room.webp', label: 'Playgroup Classroom', color: '#22c55e' },
    { src: '/images/campus/campus-sky-room.webp', label: 'MTPG Classroom', color: '#06b6d4' },
    { src: '/images/campus/campus-space-room.webp', label: 'MTPG Classroom', color: '#6366f1' },
    { src: '/images/campus/campus-ocean-room.webp', label: 'Playgroup Classroom', color: '#0ea5e9' },
    { src: '/images/campus/campus-cloud-room.webp', label: 'Nursery Classroom', color: '#a78bfa' },
    { src: '/images/campus/campus-blue-room.webp', label: 'Nursery Classroom', color: '#2563eb' },
    { src: '/images/campus/campus-library.webp', label: 'Library', color: '#d97706' },
    { src: '/images/campus/campus-reading-room.webp', label: 'Library', color: '#ea580c' },

...
import { bestPreschoolFAQs } from "@shared/best-preschool-faq-data";
...
// FAQ data is now sourced from @shared/best-preschool-faq-data (bestPreschoolFAQs)
// so both SSR (bot) and client use identical question/answer content.
...
export default function BestPreschoolInThane() {
  ...
  const structuredData = [
    ...
    createFAQSchema(bestPreschoolFAQs),
            ...
            <section className="py-8 md:py-12 px-4 bg-white dark:bg-gray-800" style={{ contentVisibility: 'auto', containIntrinsicSize: '0 800px' }}>
              <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-2 md:space-y-3">
                  {bestPreschoolFAQs.map((faq, index) => {

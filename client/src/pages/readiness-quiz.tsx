...
function getResult(score: number) {
  if (score >= 8) {
    return {
      ...
      recommendation: "We recommend enrolling your child in a quality preschool programme. At Rainbow Preschool International, our Playgroup (1.5-2.5 years), Nursery (2.5–3.5 years), and Kindergarten (3.5–5.5 years) programmes are designed to nurture each child's unique developmental stage.",

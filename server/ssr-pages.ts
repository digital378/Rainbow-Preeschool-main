...
const staticPages: Record<string, PageSEOData> = {
  "/": {
    title: "Rainbow Preschool International - Best Preschool in Thane Since 2007",
    description: "Rainbow Preschool International is a trusted preschool and playgroup in Thane offering safe, play-based learning for children aged 1.5-6 years. 6 centres across Thane. Enquire now.",
    keywords: "best preschool in thane, preschool in thane, playgroup in thane, nursery school thane, early childhood education thane",
    canonical: `${BASE_URL}/`,
    h1: "Best Preschool in Thane — Rainbow Preschool International",
    introText: "Rainbow Preschool International has been nurturing young minds since 2007. With 6 centres across Thane West and over 1,00,000 alumni, we offer Playgroup, Nursery, and Kindergarten programmes for children aged 1.5 to 6 years.",
    structuredData: [organizationSchema, websiteSchema],
    contentSections: [
      { heading: "Our Programmes", items: ["Playgroup (1.5–2.5 years) — Learning through play", "Nursery (2.5–4 years) — Building foundations", "Kindergarten (4–6 years) — School readiness"] },
      { heading: "Why Choose Rainbow Preschool?", items: ["17+ years of excellence in early childhood education", "6 centres across Thane West", "100% female teaching staff", "Small batch sizes of 10-12 children", "Play-based, child-centric curriculum", "CCTV surveillance and secure premises"] },
      { heading: "Our Centres in Thane", items: ["Manpada (Ghodbunder Road)", "Hariniwas (Naupada)", "Anand Nagar (Majiwada)", "Dhokali (Kolshet Road)", "Kalwa", "Kasarvadavali (Ghodbunder Road)"] },
      { heading: "Awards & Recognition", text: "Recognised by India Today, ScooNews Global Educators Fest, World Education Summit, Economic Times, National School Awards, and Thane Municipal Corporation." },
    ],

  ...
  "/": {
    ...
    contentSections: [
      ...
      { heading: "Find a Programme Near You", text: "Explore our dedicated landing pages for every programme and locality search — each page covers age fit, curriculum, daily routine, FAQs and admission steps:", links: [
        ...
        { text: "Playgroup in Thane", url: "/playgroup" },
        { text: "Nursery in Thane", url: "/nursery" },
        { text: "Kindergarten in Thane", url: "/kindergarten" },
      ]},
    ],
  ...
  "/best-preschool-near-me-in-thane": {
    ...
    structuredData: [organizationSchema, websiteSchema, ...branchLocalBusinessSchemas, {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "What programmes does Rainbow Preschool offer in Thane?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International offers Playgroup (1.5–2.5 years) for sensory play and social introduction; Nursery (2.5–3.5 years) for phonics, numeracy, art, and language foundations; Jr. KG (3.5–4.5 years) for structured literacy and creative development; Sr. KG (4.5–5.5 years) for comprehensive school-readiness; Happy Times after-school enrichment (3–10 years) with homework support, arts, and sports; and Daycare (2–10 years) with flexible hours for working parents." } },
        { "@type": "Question", name: "Which Rainbow Preschool centre is closest to me in Thane?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International operates 6 centres across Thane — Manpada (near Aggarwal Compound, central Thane), Hariniwas (Hariniwas Circle area), Anand Nagar (Majiwada locality), Dhokali (accessible from Ghodbunder Road), Kalwa (serving Kalwa and Mumbra), and Kasarvadavali (Ghodbunder corridor). Call +91 82915 68972 to confirm the nearest centre to your home." } },
        ...
        { "@type": "Question", name: "How does Rainbow Preschool compare with Kidzee in Thane?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International and Kidzee are both well-established in Thane. Key differences: Rainbow is Thane-origin (founded 2007) with a proprietary curriculum developed in-house over 18 years, not a national franchise. Rainbow has 6 dedicated Thane centres versus Kidzee's 3 to 4. Rainbow holds a 4.7-star Google rating from 3,997+ verified parent reviews — the highest-reviewed preschool chain in Thane. Rainbow's curriculum is aligned to NEP 2020 and updated annually by its own curriculum team, while Kidzee uses the iLead franchise kit. Rainbow also enforces a 100% female, ECE-certified staff policy and has received national awards from India Today, ScooNews, and the Economic Times." } },
        ...
        { "@type": "Question", name: "What makes a preschool the best for early childhood education?", acceptedAnswer: { "@type": "Answer", text: "The best preschools share these qualities: ECE-qualified, experienced educators who understand child development rather than just academic content; small class sizes capped at 10 to 15 children for genuine individual attention; a play-based, NEP-aligned curriculum that builds skills through exploration and never through rote memorisation; a safe, hygienic campus with CCTV, child-proof furniture, and clean outdoor play spaces; transparent and frequent parent communication including daily feedback and regular progress updates; and a measurable track record of school-readiness so children transition confidently to Class 1." } },
        { "@type": "Question", name: "Which preschool in Thane offers the best value for fees?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International offers transparent, competitive fees that cover trained ECE-qualified teachers, a proprietary award-winning curriculum, CCTV-monitored campuses, all learning materials, activity programmes including art, music, yoga, and sports, and comprehensive daily parent communication. There are no hidden charges — the full fee breakdown is shared before admission is confirmed. Flexible payment plans (monthly, quarterly, or annual) are available. Sibling concessions and alumni-family discounts are also offered. For exact fees at your preferred centre, call 82915 68972." } },
        { "@type": "Question", name: "Is there a preschool in Thane with 100% female teaching staff?", acceptedAnswer: { "@type": "Answer", text: "Yes — Rainbow Preschool International maintains a 100% female teaching and care staff policy across all 6 Thane centres, without exception. Every educator, classroom assistant, and daycare staff member is female, background-verified, and holds an ECE certification or Montessori training qualification. This policy extends to after-school care and daycare as well. Parents consistently cite this as their primary reason for choosing Rainbow — it creates a warm, safe, and nurturing environment for children aged 1.5 to 6 years." } },
        ...
        { "@type": "Question", name: "Is there a preschool near me in Kasarvadavali or on Ghodbunder Road, Thane?", acceptedAnswer: { "@type": "Answer", text: "Yes — Rainbow Preschool International has two centres on Ghodbunder Road. The Kasarvadavali centre is at Rosa Gardenia, next to Parijat Gardens, behind Hypercity Mall, serving Kasarvadavali, Hiranandani Meadows, and Brahmand. The Manpada centre is at Aggarwal Arcade near Khewra Circle, serving Hiranandani Estate, Patlipada, and lower Ghodbunder Road. Both centres offer Playgroup (1.5–2.5 yrs), Nursery (2.5–4 yrs), and Kindergarten (4–6 yrs) with identical curriculum and safety standards. Call +91 82915 68972 to confirm the nearest centre to your residential society." } },
        { "@type": "Question", name: "How does Rainbow Preschool compare with EuroKids in Thane?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International has 6 dedicated Thane West centres versus EuroKids' 3–4 in Thane. Rainbow holds a 4.7-star Google rating from 3,997+ verified parent reviews, compared with EuroKids' 4.1-star average in Thane. Rainbow uses a proprietary NEP 2020-aligned ECCE curriculum developed in-house over 18 years; EuroKids uses the EuroStar franchise programme. Rainbow accepts children from 1.5 years (Playgroup); EuroKids typically from 2.5 years. Rainbow enforces a 100% female, ECE-certified staff policy at all centres; EuroKids policy varies by franchise owner. Rainbow has received recognition from India Today, ScooNews, the Economic Times, and the World Education Summit." } },
        { "@type": "Question", name: "Which preschool in Thane has the highest Google rating and most parent reviews?", acceptedAnswer: { "@type": "Answer", text: "Based on verified Google Maps reviews as of 2026, Rainbow Preschool International holds the highest aggregate rating among preschool chains in Thane: 4.7 stars from 3,997+ verified parent reviews across all 6 Thane West centres. For comparison: Kangaroo Kids averages 4.3 stars (1 centre in Thane), Kidzee 4.2 stars (3–4 centres), EuroKids 4.1 stars (3–4 centres), and TreeHouse 4.0 stars (1–2 centres). We recommend checking Google Maps directly for current ratings before making your final decision." } },
        { "@type": "Question", name: "What is the step-by-step admission process at Rainbow Preschool in Thane?", acceptedAnswer: { "@type": "Answer", text: "Rainbow Preschool International follows a simple 5-step admission process with no entrance test, parent interview, or donation. Step 1: Enquire by phone (+91-8291568972), WhatsApp, or the online callback form. Step 2: Schedule a free campus visit at your nearest Thane centre (Mon–Sat, including evenings). Step 3: Tour classrooms and meet the lead teacher with no pressure or obligation. Step 4: Complete the admission form and submit a birth certificate, vaccination record, and 2 passport-size photographs. Step 5: Your child starts on a date that suits your family; mid-year admissions are available at all 6 Thane centres." } },

...
const staticPages: Record<string, PageSEOData> = {
  ...
  "/top-preschools-in-thane": {
    ...
    contentSections: [
      ...
      { heading: "Top 10 Preschools in Thane 2026", items: ["#1 Rainbow Preschool International — 4.7★, 3,997+ reviews, 6 centres", "#2 EuroKids — 4.2★, multiple locations", "#3 Kidzee — 4.0★, iLLUME curriculum", "#4 Podar Jumbo Kids — 4.1★, experiential learning", "#5 Kangaroo Kids — 4.0★, international curriculum", "#6 Bachpan Play School — 3.9★, affordable", "#7 Little Millennium — 4.0★, value education", "#8 Oi Playschool — 3.8★, play-centric", "#9 Footprints Childcare — 3.9★, daycare + preschool", "#10 Tree House Play Group — 3.7★, established brand"] },
    ],
    internalLinks: commonInternalLinks,
  },
  "/testimonials": {

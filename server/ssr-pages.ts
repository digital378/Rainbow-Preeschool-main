...
const staticPages: Record<string, PageSEOData> = {
  ...
  "/about/dr-meghna-rai": {
    ...
    h1: "Dr. Meghna Rai — Founder & Director, Rainbow Preschool International",
    introText: "Dr. Meghna Rai is the Founder and Director of Rainbow Preschool International, Thane. With a doctorate in Education and over 20 years of experience in early childhood education, she established Rainbow Preschool in 2007 with a vision to deliver world-class preschool education to families across Thane.",
    ...
    structuredData: [{
      ...
      description: "Dr. Meghna Rai is the Founder and Director of Rainbow Preschool International, Thane. With over 20 years of experience in early childhood education and a doctorate in Education, she established Rainbow Preschool in 2007.",
      ...
      knowsAbout: ["Early Childhood Education", "Educational Leadership", "Preschool Administration", "Child Development", "Play-Based Learning", "NEP 2020 Early Childhood Framework"],
      sameAs: [`${BASE_URL}/about/dr-meghna-rai`],
      founder: { "@type": "EducationalOrganization", name: "Rainbow Preschool International", url: BASE_URL },
    }],
    contentSections: [
      { heading: "Qualifications & Credentials", items: ["Doctor of Education (Ed.D) — University of Mumbai", "M.Ed in Educational Psychology — S.N.D.T. Women's University", "20+ years of experience in early childhood education and leadership", "Founder of Rainbow Preschool International (Est. 2007)"] },
      { heading: "Founder's Vision", text: "Dr. Rai founded Rainbow Preschool International with the vision that every child in Thane deserves a joyful, safe, and developmentally rich early education. The play-based, activity-driven curriculum she championed has since become the cornerstone of Rainbow's identity across 6 centres." },
      { heading: "Areas of Leadership", items: ["Educational leadership and preschool governance", "Teacher training and professional development", "Child safety policy and quality assurance", "Strategic growth and centre expansion", "NEP 2020 early childhood compliance", "Community engagement and parent education"] },
    ],
    internalLinks: [...commonInternalLinks, { text: "About Rainbow Preschool", url: "/about" }, { text: "Meet Akheela Balbale", url: "/about/akheela-balbale" }],
  },
  "/faqs": {

...
const staticPages: Record<string, PageSEOData> = {
  ...
  "/kindergarten": {
    ...
    contentSections: [
      ...
      { heading: "Admission & Timings", text: "Kindergarten (Junior KG and Senior KG) admissions are open for children aged 3.5 to 5.5 years. School hours are 8:30 AM to 1:00 PM, Monday to Friday. Extended day care is available at select centres. Rainbow Preschool operates 6 Kindergarten centres across Thane West — Manpada, Hariniwas Circle, Anand Nagar, Dhokali, Kalwa, and Kasarvadavali. Contact us at +91 82915 68972 or visit any centre for a free demo class." },
    ],
  ...
  "/play-school-near-me": {
    ...
    structuredData: [organizationSchema, websiteSchema, ...branchLocalBusinessSchemas, {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "Are play schools near me in Thane safe for toddlers?", acceptedAnswer: { "@type": "Answer", text: "At Rainbow Preschool, safety is our highest priority. All 6 centres have CCTV-enabled classrooms and campuses, 100% female teaching staff, child-proofed furniture, daily sanitisation of toys and surfaces, and secure entry/exit systems. We maintain small batch sizes of 10-12 children for individual attention and close supervision." } },
        ...
        { "@type": "Question", name: "Is there a play school near Majiwada in Thane?", acceptedAnswer: { "@type": "Answer", text: "Yes. Rainbow Preschool's Anand Nagar centre is located at Kris Commercial Plaza, directly opposite Tropical Lagoon at Majiwada Junction, Thane West. It is the nearest Rainbow play school for families in Anand Nagar, Majiwada, Vasant Vihar, and Kapurbawdi. Visit /preschool-in-anand-nagar-thane or call 98337 81550 for details." } },
        ...
        { "@type": "Question", name: "Is there a Rainbow play school near Kolshet Road or Dhokali Naka?", acceptedAnswer: { "@type": "Answer", text: "Yes. Rainbow Preschool's Dhokali centre is located directly on Kolshet Road at Dhokali Naka, opposite Aban Park Society. It is the nearest Rainbow play school for families in Dhokali, Kolshet Road, Vandana Nagar, and Balkum. Call 93212 38375 or visit /preschool-in-dhokali-thane for more information." } },
        { "@type": "Question", name: "What is the difference between a play school near me and a preschool near me?", acceptedAnswer: { "@type": "Answer", text: "Both phrases describe the same type of early learning setting. Parents searching for a 'play school near me' or a 'preschool near me' are looking for a structured, safe environment where young children aged 1.5 to 5.5 years learn through play. At Rainbow Preschool in Thane, our Playgroup (1.5–2.5 yrs), Nursery (2.5–3.5 yrs), and Kindergarten (3.5–5.5 yrs) programmes form a complete preschool — making us your neighbourhood play school and preschool, all in one." } },
        ...
        { "@type": "Question", name: "What should I look for in a preschool near me?", acceptedAnswer: { "@type": "Answer", text: "When choosing a preschool near you, evaluate: safety (CCTV-enabled classrooms, 100% female teaching staff, daily hygiene routines), curriculum (play-based, not rote learning), teacher qualifications and class size (10–12 per batch at Rainbow), location convenience, and transparent parent communication. Rainbow Preschool scores strongly on all these criteria with its 18+ year track record in Thane." } },
...
//                       public page.
const noIndexPages = ["/ad", "/ad-google", "/flyer", "/RIS", "/ris", "/ris-11th", "/gsc", "/GSC", "/join-now"];
